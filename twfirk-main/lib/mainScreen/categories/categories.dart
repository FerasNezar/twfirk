...
class Categories extends StatefulWidget {
  ...
  Categories(this.parentContext);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return CategoriesSatate(parentContext);
  }
}

List<CategoryModel> cateModel = [];

class CategoriesSatate extends State<Categories> {
  bool _load = false;
  ...
  CategoriesSatate(this.parentContext);
      ...
      body: Stack(
        children: <Widget>[
          if (cateModel.isNotEmpty)
            GridView.count(
              crossAxisCount: 2,
              children: List.generate(cateModel.length, (index) {
                return GestureDetector(child: Container(
                  ...
                  Navigator.push(parentContext, MaterialPageRoute(builder: (context) => Result(type: "",id: cateModel[index].id,)));
                },);
              }),
            ),
          if(cateModel.isEmpty)
